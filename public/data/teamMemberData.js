export const teamMembers = [
  ...
  <div class="about">
    <h3>소개</h3>
    <p>
      소개 : 23년 8월부터 KDT 훈련을 배우고 있는 훈련생 홍문기입니다. 개발과정을 수강하면서 컴퓨터 프로그래밍 쪽에 많은 흥미를 느끼면서 배우고 있습니다. 제가 짜는 코드로 한치의 오차도 없이 작동한다는 것에 매력을 느꼈고, 꾸준히 공부해나가 실력있는 개발자가 되기 위해 노력하고 있습니다. 현재 공부하고있는 분야는 react를 활용한 단일페이지 웹,앱서비스를 하는것과 데이터베이스를 웹,앱에 연결해서 자유자재로 사용하는 것을 목표하고 있습니다. 그 외에도 필요하다고 생각하는 기술들은 거부감없이 다 공부하려고 합니다.
    </p>
  </div>
  `},
];