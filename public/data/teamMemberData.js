export const teamMembers = [
  ...
  <div class="about">
    <p>
      저는 도전적인 개발자를 꿈꾸는 두 아이의 아빠이자 남편인 김현입니다. <br>
      오랜시간동안 영업이라는 다른 직업을 가지고 일을 해왔으나 실리콘밸리의 자기도전적이고 세상을 바꾸는데 노력하는 다양한 개발자들을 보고 개발자라는 꿈을 꾸게 되었습니다.
      <br>
      늦게 시작한만큼 아직 부족함을 많이 느끼지만 세상을 위해, 꿈을 위해 열심히 도전하는 개발자가 되도록 나아가겠습니다.
    </p>
  </div>
  `},
  {
    ...
    <div class="about">
      <p>
        23년 8월부터 KDT 훈련을 배우고 있는 훈련생 신동현입니다. 자바스크립트를 시작으로 과정을 수료중인데, 현재 데이터베이스와 모듈화에 대한 훈련을 개인적으로 공부하고있고, 디버깅을 통한 설계 방식을 이용하여 프로젝트를 진행하고 있습니다. 현재 개인프로젝트로 익명토론 게시판을 제작 중 입니다.
      </p>
    </div>
  ` },
  {
  ...
  <div class="about">
    <p>
      안녕하세요 저는 윤준현입니다.<br>
      취미로 개발 관련 서적을 읽고, 공부를 하는 것이 목표입니다.<br>
      현재 저는 프론트와 백엔드를 가리지 않고 공부를 하고자 합니다.<br>
      지금은 React에 대해 공부하고 있으며 후에 추후 DB를 다뤄보고 데이터 관계도 및 설계하는 연습을 하고자 합니다.
    </p>
  </div>
  `
  },
  ...
  <div class="about">
    <p>
      23년 8월부터 KDT 훈련을 배우고 있는 훈련생 홍문기입니다. 개발과정을 수강하면서 컴퓨터 프로그래밍 쪽에 많은 흥미를 느끼면서 배우고 있습니다. 제가 짜는 코드로 한치의 오차도 없이 작동한다는 것에 매력을 느꼈고, 꾸준히 공부해나가 실력있는 개발자가 되기 위해 노력하고 있습니다. 현재 공부하고있는 분야는 react를 활용한 단일페이지 웹,앱서비스를 하는것과 데이터베이스를 웹,앱에 연결해서 자유자재로 사용하는 것을 목표하고 있습니다. 그 외에도 필요하다고 생각하는 기술들은 거부감없이 다 공부하려고 합니다.
    </p>
  </div>
  `},
];